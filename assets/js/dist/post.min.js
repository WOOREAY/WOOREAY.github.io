...
(function () {
  ...
  */
  ...
  function setCodeClipboard() {
    ...
    [...clipboardList].map(elem => new Tooltip(elem, {
      placement: 'left'
    }));
  ...
  _defineProperty(TocMobile, "invisible", true);
  _defineProperty(TocMobile, "barHeight", 16 * 3);
  // 3rem
  _defineProperty(TocMobile, "options", {
    ...
    scrollSmooth: false,
    collapseDepth: 4,
    headingsOffset: _TocMobile.barHeight
  });
